...
x_train = np.asarray(data["xtrain_lidar"])
y_train = np.asarray(data["ytrain_radar"])
x_test = np.asarray(data["xtest_lidar"])
...
plt.savefig('C:/Users/sb3682.ECE-2V7QHQ3/My Stuff/Traffic_Sign/Radar+Camera/results/Lidar_confusion_matrix.png')
plt.show()
